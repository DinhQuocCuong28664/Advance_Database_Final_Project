...
const ADMIN_TABS = [
  { key: 'frontdesk', label: '≡ƒÅ¿ Front Desk', note: 'Arrivals, departures, transfers, and stay actions' },
  { key: 'inventory', label: 'ΓÜÖ∩╕Å Inventory', note: 'Room availability and status control' },
  { key: 'housekeeping', label: '≡ƒº╣ Housekeeping', note: 'Cleaning tasks, assignments, and room status' },
  { key: 'maintenance', label: '≡ƒöº Maintenance', note: 'Issue tracking, repairs, and room status' },
  { key: 'invoice', label: '≡ƒôï Invoices', note: 'Generate and issue guest invoices' },
  { key: 'rates', label: '≡ƒÆ░ Rates', note: 'Manage nightly room rates with Price Guard protection' },
  { key: 'promotions', label: '≡ƒÄü Promotions', note: 'Create and manage hotel promotions and offers' },
  { key: 'channels', label: '≡ƒîÉ Channels', note: 'Booking channel stats and location hierarchy tree' },
  { key: 'payments', label: '≡ƒÆ│ Payments', note: 'Payment history, filters and transaction review' },
  { key: 'accounts', label: '≡ƒæñ Accounts', note: 'System and guest login management' },
  { key: 'timeline', label: '≡ƒòÆ Timeline', note: 'Reservation status audit trail and history' },
  { key: 'reports', label: '≡ƒôè Reports', note: 'KPIs, exports, and revenue analytics' },
];
