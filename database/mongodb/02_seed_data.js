...
async function seedMongoDB() {
  ...
  try {
    ...
    console.log('[OK] amenity_master: 8 documents + indexes');
    ...
    console.log('[OK] room_type_catalog: 7 documents + indexes');
    ...
    console.log('[OK] Hotel_Catalog: 3 hotels + indexes');

    console.log('\n');
    console.log('[OK] MongoDB SEED COMPLETE');
    ...
    console.error('[ERROR] MongoDB Seed Error:', err.message);
    process.exit(1);
  } finally {
    await client.close();
  }
