...
function ReservationCard({ r, onCancel }: { r: Reservation; onCancel?: (reservation: Reservation) => void }) {
  ...
  const canCancel = r.reservation_status === 'CONFIRMED' && onCancel;
      ...
      <section className="page-card resv-lookup-card">
        ...
        {lookupResult && (
          <div className="resv-lookup-result">
            ...
            <ReservationCard r={lookupResult} />
