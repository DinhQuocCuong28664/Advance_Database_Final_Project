...
type ReservationResult = Record<string, any>;
...
function fmt(n: number | string | null | undefined, currency = 'VND') {
...
export default function BookingPage() {
  ...
  const [voucherStatus, setVoucherStatus] = useState<VoucherStatus>({ checking: false, valid: null, data: null, error: null });
  ...
  if (step === 'done' && reservation) {
    ...
    const remaining    = Number(grandTotal) - Number(paidDeposit);
      ...
      <div className="booking-layout">
              ...
              <div className="booking-form-grid">
                ...
                <label className="field-span-2">
                  ...
                  {!voucherStatus.checking && voucherStatus.valid === true && voucherStatus.data && (
                    ...
                    {Number(voucherStatus.data.discount_amount || 0) > 0 && (
        ...
        <aside className="booking-summary">
          ...
          <div className="booking-summary-body">
            ...
            {voucherStatus.valid === true && voucherStatus.data && Number(voucherStatus.data.discount_amount || 0) > 0 && (
              <>
            ...
            {(!voucherStatus.valid || !voucherStatus.data || Number(voucherStatus.data.discount_amount || 0) <= 0) && (
