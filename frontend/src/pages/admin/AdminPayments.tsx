...
//  Helpers 
const fmtCurrency = (amount: number | string | null | undefined, currency = 'USD') =>
...
const TYPE_LABELS: Record<string, LabelInfo> = {
...
//  Component 
export default function AdminPayments({ hotels = [] }: AdminPaymentsProps) {
  ...
  const countByType = payments.reduce<Record<string, number>>((acc, p) => {
