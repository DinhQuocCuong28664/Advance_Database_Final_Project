...
type ReportRow = any;
type ReportDoc = jsPDF & { lastAutoTable?: { finalY: number } };
...
export default function AdminReports({ reportSummary, revenueData, brandRevenueData = [], loading }: { reportSummary: any; revenueData: ReportRow[]; brandRevenueData?: ReportRow[]; loading?: boolean }) {
  ...
  function exportPDF() {
    const doc = new jsPDF({ orientation: 'landscape' }) as ReportDoc;
